...
- [x] Ejercicios 1.1 a 5.2 implementados en Java
- [x] Aplicacion compilada y ejecutada sin errores no controlados
- [x] Validado `Arrays.binarySearch()` sobre arreglo previamente ordenado
- [x] Validada la captura de `UnsupportedOperationException` en lista inmutable
- [x] Validada la unicidad de `HashSet` mediante `size()`
